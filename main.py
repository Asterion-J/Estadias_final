...
MOLECULAS_PREDEFINIDAS = {
    ...
    'anastrozol': {
        ...
        'nombre': 'Anastrozol',
        'descripcion': 'Inhibidor de aromatasa usado en el tratamiento de cáncer de mama hormonosensible'
    },
    'progesterona': {
        'smiles': 'CC(=O)[C@H]1CC[C@@H]2[C@@]1(CC[C@H]3[C@H]2CCC4=CC(=O)CC[C@]34C)C',
        'nombre': 'Progesterona',
        'descripcion': 'Hormona sexual femenina, importante en el ciclo menstrual y embarazo'
    },
    'tamoxifeno': {
        'smiles': 'CC/C(=C(\C1=CC=CC=C1)/C2=CC=C(C=C2)OCCN(C)C)/C3=CC=CC=C3',
        'nombre': 'Tamoxifeno',
        'descripcion': 'Modulador selectivo del receptor de estrógenos, usado en tratamiento de cáncer de mama'
    },
}
